...
CHUNK_SIZE = 200  # Размер чанков для слов в предложениях (legacy)
CHUNK_OVERLAP = 10  # Перекрытие между чанками в предложениях (legacy)

# Новые настройки чанкинга (Phase 1, рекомендуется использовать их)
